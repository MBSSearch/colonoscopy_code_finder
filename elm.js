...
var author$project$Main$Answers = function (a) {
	return {$: 'Answers', a: a};
};
var author$project$Main$Node = F2(
	function (text, answers) {
		return {answers: answers, text: text};
	});
...
function author$project$Main$cyclic$answerDecoder() {
	return A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'next',
		elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					author$project$Main$cyclic$answerNextQuestionDecoder(),
					author$project$Main$answerNextNumberDecoder,
					author$project$Main$answerNextErrorDecoder
				])),
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'text',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Main$Answer)));
}
function author$project$Main$cyclic$answerNextQuestionDecoder() {
	return A2(
		elm$json$Json$Decode$map,
		author$project$Main$Question,
		author$project$Main$cyclic$nodeDecoder());
}
function author$project$Main$cyclic$nodeDecoder() {
	return A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'answers',
		A2(
			elm$json$Json$Decode$map,
			author$project$Main$Answers,
			elm$json$Json$Decode$list(
				elm$json$Json$Decode$lazy(
					function (_n0) {
						return author$project$Main$cyclic$answerDecoder();
					}))),
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'text',
...
try {
	var author$project$Main$answerDecoder = author$project$Main$cyclic$answerDecoder();
	author$project$Main$cyclic$answerDecoder = function () {
		return author$project$Main$answerDecoder;
	};
	var author$project$Main$answerNextQuestionDecoder = author$project$Main$cyclic$answerNextQuestionDecoder();
	author$project$Main$cyclic$answerNextQuestionDecoder = function () {
		return author$project$Main$answerNextQuestionDecoder;
	};
	var author$project$Main$nodeDecoder = author$project$Main$cyclic$nodeDecoder();
	author$project$Main$cyclic$nodeDecoder = function () {
		return author$project$Main$nodeDecoder;
	};
} catch ($) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Select':
				var answer = msg.a;
				if (model.$ === 'Success') {
					var decisionModel = model.a;
					var _n3 = decisionModel.selection;
					if (_n3.$ === 'Question') {
						var currentNode = _n3.a;
						var newHistory = _Utils_ap(
							decisionModel.history,
							_List_fromArray(
								[currentNode]));
						var _n4 = answer.next;
						switch (_n4.$) {
								...
								return _Utils_Tuple2(
									author$project$Main$Success(
										_Utils_update(
											...
											{
												history: newHistory,
												selection: author$project$Main$Question(node)
											})),
									elm$core$Platform$Cmd$none);
							case 'Number':
								var itemNumber = _n4.a;
								return _Utils_Tuple2(
									author$project$Main$Success(
										_Utils_update(
											decisionModel,
											{
												history: _Utils_ap(
													...
													_List_fromArray(
														[currentNode])),
												selection: author$project$Main$Number(itemNumber)
											})),
									elm$core$Platform$Cmd$none);
							default:
								var message = _n4.a;
										...
										_Utils_update(
											decisionModel,
											{
												history: _Utils_ap(
													...
													_List_fromArray(
														[currentNode])),
												selection: author$project$Main$Error(message)
											})),
									elm$core$Platform$Cmd$none);
						}
					} else {
			...
			default:
				if (model.$ === 'Success') {
					var decisionModel = model.a;
					var remainder = elm$core$List$reverse(
						A2(
							elm$core$List$drop,
							1,
							elm$core$List$reverse(decisionModel.history)));
					var lastElement = elm$core$List$head(
						elm$core$List$reverse(decisionModel.history));
					if (lastElement.$ === 'Just') {
						var node = lastElement.a;
						return _Utils_Tuple2(
							author$project$Main$Success(
								_Utils_update(
									decisionModel,
				...
				A2(
					...
					function (answer) {
						return A2(
							...
							_List_fromArray(
								[
									author$project$Main$viewAnswer(answer)
								]));
					},
					node.answers))
			]));
		...
		case 'Failure':
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'There\'s been an error: ' + author$project$Main$toString(error))
					]));
		default:
			var decisionModel = model.a;
			return elm$core$List$isEmpty(decisionModel.history) ? A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
